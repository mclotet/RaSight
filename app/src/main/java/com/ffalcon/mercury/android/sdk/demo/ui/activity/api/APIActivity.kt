...
import com.ffalcon.mercury.android.sdk.bridge.RayneoInfoManager
...
class APIActivity : BaseMirrorActivity<ActivityApiBinding>() {
    val APP_ID = "e59a0320025cf19c6f9bb57573be045d"
    val SECRET_KEY =
        ""
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        initGPS()
        mBindingPair.updateView {
            tvSn.text = "SN:${RayneoInfoManager.getGlassSN(this@APIActivity, APP_ID, SECRET_KEY)}"
            tvUid.text =
                "UID:${RayneoInfoManager.getGlassUID(this@APIActivity, APP_ID, SECRET_KEY)}"
            tvWear.text = "IS WEARING:${MobileState.isWearing()}"
        }
    }
